...
/// </summary>
public interface IMockVerifyInvoked<out T> : IInteractiveMock<T>;
...
/// <summary>
///     Check which methods got invoked on the mocked instance for <typeparamref name="T" /> when it contains a
...
/// </summary>
public interface IMockVerifyInvokedWithEqualsWithGetHashCode<T> : IMockVerifyInvokedWithEquals<T>,
	IMockVerifyInvokedWithGetHashCode<T>;
...
/// <summary>
///     Check which methods got invoked on the mocked instance for <typeparamref name="T" /> when it contains a
///     <see cref="object.ToString()" /> and <see cref="object.Equals(object)" /> method.
/// </summary>
public interface IMockVerifyInvokedWithToStringWithEquals<T> : IMockVerifyInvokedWithToString<T>,
	IMockVerifyInvokedWithEquals<T>;

/// <summary>
///     Check which methods got invoked on the mocked instance for <typeparamref name="T" /> when it contains a
///     <see cref="object.ToString()" />, <see cref="object.Equals(object)" /> and <see cref="object.GetHashCode()" />
///     method.
/// </summary>
public interface IMockVerifyInvokedWithToStringWithEqualsWithGetHashCode<T> : IMockVerifyInvokedWithToString<T>,
	IMockVerifyInvokedWithEquals<T>, IMockVerifyInvokedWithGetHashCode<T>;

/// <summary>
///     Check which methods got invoked on the mocked instance for <typeparamref name="T" /> when it contains a
///     <see cref="object.ToString()" /> and <see cref="object.GetHashCode()" /> method.
/// </summary>
public interface IMockVerifyInvokedWithToStringWithGetHashCode<T> : IMockVerifyInvokedWithToString<T>,
	IMockVerifyInvokedWithGetHashCode<T>;
