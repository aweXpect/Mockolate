...
public class MockAccessed<T, TMock>(Checks checks, TMock mock) : IMockAccessed<TMock>
{
	...
	/// <inheritdoc cref="IMockAccessed{T}.PropertyGetter(string)" />
	...
	/// <inheritdoc cref="IMockAccessed{T}.PropertySetter(string, With.Parameter)" />
	...
	/// <summary>
	///     A proxy implementation of <see cref="IMockAccessed{T}" /> that forwards all calls to the provided
