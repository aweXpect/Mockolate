...
/// </summary>
public abstract class IndexerSetup
{
	...
	internal class Default : IndexerSetup
	{
		private object? _value;

		/// <inheritdoc cref="IndexerSetup.InvokeSetter(object?)" />
		protected override void InvokeSetter(object? value) => _value = value;

		/// <inheritdoc cref="IndexerSetup.InvokeGetter{TResult}()" />
...
///     Sets up an indexer.
/// </summary>
public class IndexerSetup<T> : IndexerSetup
{
	...
	/// </summary>
	public IndexerSetup<T> InitializeWith(T value)
	{
		_value = value;
		return this;
	}
	...
	/// </remarks>
	public IndexerSetup<T> OnGet(Action callback)
	{
		_getterCallback = v =>
		{
			callback();
	...
	///     one callback can be registered; subsequent calls to this method will replace any previously set callback.
	/// </remarks>
	public IndexerSetup<T> OnSet(Action<T> callback)
	{
