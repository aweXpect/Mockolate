...
public static class ReturnsAsyncExtensions
{
	...
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<Task<TReturn>, T1> ReturnsAsync<TReturn, T1>(
	...
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<Task<TReturn>, T1, T2> ReturnsAsync<TReturn, T1, T2>(
	...
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<Task<TReturn>, T1, T2, T3> ReturnsAsync<TReturn, T1, T2, T3>(
	...
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<Task<TReturn>, T1, T2, T3, T4> ReturnsAsync<TReturn, T1, T2, T3, T4>(
...
#pragma warning disable CA2012 // Use ValueTasks correctly
	...
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>> ReturnsAsync<TReturn>(
		this ReturnMethodSetup<ValueTask<TReturn>> setup, TReturn returnValue)
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>> ReturnsAsync<TReturn>(
		this ReturnMethodSetup<ValueTask<TReturn>> setup, Func<TReturn> callback)
		=> setup.Returns(() => ValueTask.FromResult(callback()));

	/// <summary>
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1> ReturnsAsync<TReturn, T1>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1> setup, TReturn returnValue)
		=> setup.Returns(ValueTask.FromResult(returnValue));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1> ReturnsAsync<TReturn, T1>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1> setup, Func<TReturn> callback)
		=> setup.Returns(() => ValueTask.FromResult(callback()));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1> ReturnsAsync<TReturn, T1>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1> setup, Func<T1, TReturn> callback)
		=> setup.Returns(v1 => ValueTask.FromResult(callback(v1)));

	/// <summary>
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2> ReturnsAsync<TReturn, T1, T2>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2> setup, TReturn returnValue)
		=> setup.Returns(ValueTask.FromResult(returnValue));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2> ReturnsAsync<TReturn, T1, T2>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2> setup, Func<TReturn> callback)
		=> setup.Returns(() => ValueTask.FromResult(callback()));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2> ReturnsAsync<TReturn, T1, T2>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2> setup, Func<T1, T2, TReturn> callback)
		=> setup.Returns((v1, v2) => ValueTask.FromResult(callback(v1, v2)));

	/// <summary>
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> ReturnsAsync<TReturn, T1, T2, T3>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> setup, TReturn returnValue)
		=> setup.Returns(ValueTask.FromResult(returnValue));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> ReturnsAsync<TReturn, T1, T2, T3>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> setup, Func<TReturn> callback)
		=> setup.Returns(() => ValueTask.FromResult(callback()));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> ReturnsAsync<TReturn, T1, T2, T3>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3> setup, Func<T1, T2, T3, TReturn> callback)
		=> setup.Returns((v1, v2, v3) => ValueTask.FromResult(callback(v1, v2, v3)));

	/// <summary>
	///     Registers the <see langword="async" /> <paramref name="returnValue" /> for this method.
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> ReturnsAsync<TReturn, T1, T2, T3, T4>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> setup, TReturn returnValue)
		=> setup.Returns(ValueTask.FromResult(returnValue));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> ReturnsAsync<TReturn, T1, T2, T3, T4>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> setup, Func<TReturn> callback)
		=> setup.Returns(() => ValueTask.FromResult(callback()));
	...
	/// </summary>
	public static ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> ReturnsAsync<TReturn, T1, T2, T3, T4>(
		this ReturnMethodSetup<ValueTask<TReturn>, T1, T2, T3, T4> setup, Func<T1, T2, T3, T4, TReturn> callback)
