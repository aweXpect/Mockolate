...
- [Setup](https://docs.testably.org/category/setup): [properties](https://docs.testably.org/Mockolate/setup/properties), [methods](https://docs.testably.org/Mockolate/setup/methods), [indexers](https://docs.testably.org/Mockolate/setup/indexers), [parameter matching](https://docs.testably.org/Mockolate/setup/parameter-matching)
...
- [Special types](https://docs.testably.org/category/special-types): [`HttpClient`](https://docs.testably.org/Mockolate/special-types/httpclient), [delegates](https://docs.testably.org/Mockolate/special-types/delegates)
- [A complete example](https://docs.testably.org/Mockolate/complete-example), [comparison](https://docs.testably.org/Mockolate/comparison) with other libraries, [migration](https://docs.testably.org/Mockolate/migration) from Moq / NSubstitute
- [Analyzers](https://docs.testably.org/Mockolate/analyzers) and [benchmarks](https://docs.testably.org/Mockolate/benchmarks)
