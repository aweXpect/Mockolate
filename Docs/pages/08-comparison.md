...
sut.Mock.Setup.Method.Dispense(It.Is("Dark"), It.Is(2)).Returns(true);
sut.Mock.Setup.Indexer(It.Is("Dark")).Returns(10);
```
...
```csharp
sut.Mock.Verify.Invoked.Dispense(It.Is("Dark"), It.Is(2)).Once();
