				...
				await That(result.Sources).ContainsKey("Mock.IMyService.g.cs").WhoseValue
					.Contains("""
					          		...
					          		public int SomeProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomeProperty_Get, "global::MyCode.IMyService.SomeProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.SomeProperty);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomeProperty_Set, "global::MyCode.IMyService.SomeProperty", value);
					...
					.Contains("""
					          		...
					          		public bool? SomeReadOnlyProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<bool?>(global::Mockolate.Mock.IMyService.MemberId_SomeReadOnlyProperty_Get, "global::MyCode.IMyService.SomeReadOnlyProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(bool?)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.SomeReadOnlyProperty);
					          			}
					          		}
					          """).IgnoringNewlineStyle().And
					.Contains("""
					          		...
					          		public bool? SomeWriteOnlyProperty
					          		{
					          			set
					          			{
					          				this.MockRegistry.SetProperty<bool?>(global::Mockolate.Mock.IMyService.MemberId_SomeWriteOnlyProperty_Set, "global::MyCode.IMyService.SomeWriteOnlyProperty", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		internal int SomeInternalProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomeInternalProperty_Get, "global::MyCode.IMyService.SomeInternalProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.SomeInternalProperty);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomeInternalProperty_Set, "global::MyCode.IMyService.SomeInternalProperty", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		private int SomePrivateProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomePrivateProperty_Get, "global::MyCode.IMyService.SomePrivateProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.SomePrivateProperty);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomePrivateProperty_Set, "global::MyCode.IMyService.SomePrivateProperty", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		private protected int SomePrivateProtectedProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomePrivateProtectedProperty_Get, "global::MyCode.IMyService.SomePrivateProtectedProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.SomePrivateProtectedProperty);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_SomePrivateProtectedProperty_Set, "global::MyCode.IMyService.SomePrivateProtectedProperty", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
				...
				await That(result.Sources).ContainsKey("Mock.IMyService.g.cs").WhoseValue
					.Contains("""
					          		...
					          		public int MyDirectProperty
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyDirectProperty_Get, "global::MyCode.IMyService.MyDirectProperty", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.MyDirectProperty);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyDirectProperty_Set, "global::MyCode.IMyService.MyDirectProperty", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		public int MyBaseProperty1
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty1_Get, "global::MyCode.IMyServiceBase1.MyBaseProperty1", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.MyBaseProperty1);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty1_Set, "global::MyCode.IMyServiceBase1.MyBaseProperty1", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		public int MyBaseProperty2
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty2_Get, "global::MyCode.IMyServiceBase2.MyBaseProperty2", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.MyBaseProperty2);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty2_Set, "global::MyCode.IMyServiceBase2.MyBaseProperty2", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
					...
					.Contains("""
					          		...
					          		public int MyBaseProperty3
					          		{
					          			get
					          			{
					          				return this.MockRegistry.GetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty3_Get, "global::MyCode.IMyServiceBase3.MyBaseProperty3", () => this.MockRegistry.Behavior.DefaultValue.Generate(default(int)!), this.MockRegistry.Wraps is not global::MyCode.IMyService wraps ? null : () => wraps.MyBaseProperty3);
					          			}
					          			set
					          			{
					          				this.MockRegistry.SetProperty<int>(global::Mockolate.Mock.IMyService.MemberId_MyBaseProperty3_Set, "global::MyCode.IMyServiceBase3.MyBaseProperty3", value);
					          				if (this.MockRegistry.Wraps is global::MyCode.IMyService wraps)
					          				{
