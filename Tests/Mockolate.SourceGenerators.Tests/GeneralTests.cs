	...
	public async Task WithAttributes_ShouldAddAttributesToGeneratedCode()
	{
		...
		await That(result.Sources).ContainsKey("Mock.IMyService.g.cs").WhoseValue
			...
			.Contains("""
			          		...
			          		{
			          			var methodSetup = this.MockRegistry.GetMethodSetup<global::Mockolate.Setup.ReturnMethodSetup<string, string>>("global::MyCode.IMyService.MyMethod", m => m.Matches(message));
