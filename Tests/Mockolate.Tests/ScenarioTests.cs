...
{
	#region InScenario scope isolation
	...
	#region TransitionTo on return methods

	[Fact]
	public async Task TransitionTo_ReturnArity0_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_ReturnArity1_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_ReturnArity2_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_ReturnArity3_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_ReturnArity4_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_ReturnArity5_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	#region TransitionTo on void methods

	[Fact]
	public async Task TransitionTo_VoidArity0_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_VoidArity1_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_VoidArity2_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_VoidArity3_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_VoidArity4_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_VoidArity5_ShouldSwitchScenarioWhenInvoked()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	#region TransitionTo on properties

	[Fact]
	public async Task TransitionTo_PropertyGetter_ShouldSwitchScenarioOnRead()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_PropertySetter_ShouldSwitchScenarioOnWrite()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_PropertyGetter_ShouldNotFireOnWrite()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	[Fact]
	public async Task TransitionTo_PropertySetter_ShouldNotFireOnRead()
	{
		IScenarioService sut = IScenarioService.CreateMock();
	...
	#region TransitionTo on indexer
