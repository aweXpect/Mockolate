...
public sealed partial class VerifyInvokedTests
{
	public sealed class SpanTests
	{
		...
		public async Task Memory_WhenPredicateMatches_ShouldApplySetup()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.Satisfies<Memory<int>>(v => v.Length == 2))).Never();
			await That(mock.Mock.Verify.MyMethod(It.Satisfies<Memory<int>>(v => v.Length == 3))).Once();
			await That(mock.Mock.Verify.MyMethod(It.Satisfies<Memory<int>>(v => v.Length == 4))).Never();
		}
		...
		public async Task Memory_WithoutPredicate_ShouldApplyAllCalls()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.IsAny<Memory<int>>())).Twice();
		}
		...
		public async Task ReadOnlySpan_WhenPredicateMatches_ShouldApplySetup()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.IsReadOnlySpan<int>(v => v.Length == 2))).Never();
			await That(mock.Mock.Verify.MyMethod(It.IsReadOnlySpan<int>(v => v.Length == 3))).Once();
			await That(mock.Mock.Verify.MyMethod(It.IsReadOnlySpan<int>(v => v.Length == 4))).Never();
		}
		...
		public async Task ReadOnlySpan_WithoutPredicate_ShouldApplyAllCalls()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.IsAnyReadOnlySpan<int>())).Twice();
		}
		...
		public async Task Span_WhenPredicateMatches_ShouldApplySetup()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.IsSpan<int>(v => v.Length == 2))).Never();
			await That(mock.Mock.Verify.MyMethod(It.IsSpan<int>(v => v.Length == 3))).Once();
			await That(mock.Mock.Verify.MyMethod(It.IsSpan<int>(v => v.Length == 4))).Never();
		}
		...
		public async Task Span_WithoutPredicate_ShouldApplyAllCalls()
		{
			...
			await That(mock.Mock.Verify.MyMethod(It.IsAnySpan<int>())).Twice();
		}
