...
public sealed partial class ItExtensionsTests
{
	public sealed partial class IsUriTests
	{
		...
		{
			[Test]
			[Arguments("x", "123", "z", "345", true)]
			[Arguments("z", "345", "x", "123", true)]
			[Arguments("x", "123", "y", "345", false)]
			[Arguments("y", "345", "x", "123", false)]
			...
			[Test]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x", "123", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "y", "234", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x", "", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "y", "", false)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x", "234", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "y", "123", false)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&foo&y=234", "foo", "", true)]
			...
			[Test]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "?x=123&y=234", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "?y=234&x=123&", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x=123", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "y=234", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "y", false)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "x=234", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "y=123", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "x=123&y=23", false)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&foo&y=234", "foo", true)]
