...
public sealed partial class ItExtensionsTests
{
	public sealed partial class IsUriTests
	{
		...
		{
			[Test]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "www.awexpect.com", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "*awexpect*", true)]
			[Arguments("https://www.aweXpect.com/foo/bar?x=123&y=234", "*aweXpect*", true)]
			[Arguments("http://www.aweXpect.com/foo/bar?x=123&y=234", "mockolate.com", false)]
